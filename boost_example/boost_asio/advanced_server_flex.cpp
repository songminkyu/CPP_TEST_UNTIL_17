...
#include <boost/beast/common/detect_ssl.hpp>
#include <boost/beast/common/server_certificate.hpp>
#include <boost/beast/common/ssl_stream.hpp>
...
int main(int argc, char* argv[])
{
	...
	auto const threads = std::max<std::size_t>(1, std::atoi("4"));
